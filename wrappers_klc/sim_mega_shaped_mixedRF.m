...
function out = sim_mega_shaped_mixedRF(n,sw,Bfield,linewidth,taus,sys,edit_angle,editPulse,editTp,editPh1,editPh2,refPulse1,refPulse2,refTp1,refTp2,Gx,Gy,dx,dy,refPh1,refPh2)
...
d=sim_shapedRF(d,H,refPulse1,refTp1,180,90+refPh1,Gx,dx);  %1st shaped 180 degree refocusing pulse
%d = sim_rotate(d,H,180,refPh1);

d=sim_evolve(d,H,taus(2)/1000);                          %Evolve by taus(2)
d=sim_shapedRF(d,H,editPulse,editTp,edit_angle,90+editPh1);     %1st shaped editing pulse rotation
d=sim_evolve(d,H,taus(3)/1000);                          %Evolve by taus(3)

d=sim_shapedRF(d,H,refPulse2,refTp2,180,90+refPh2,Gy,dy);  %2nd shaped 180 degree refocusing pulse
%d = sim_rotate(d,H,180,refPh2);

d=sim_evolve(d,H,taus(4)/1000);                          %Evolve by taus(4)
d=sim_shapedRF(d,H,editPulse,editTp,edit_angle,90+editPh2);     %2nd shaped editing pulse rotation
